package aslapov.android.study.pallada.kisuknd.raids.createraid;
...
import aslapov.android.study.pallada.kisuknd.raids.editraid.BaseEditableRaidActivity;
...
public class CreateRaidActivity extends BaseEditableRaidActivity {
    ...
    protected BaseViewModel getViewModel() {
        if (mViewModel == null)
            mViewModel = new ViewModelProvider(this, new ViewModelFactory(this)).get(CreateRaidViewModel.class);
